class CompaniesController < ApplicationController
  ...
  private    
    ...
    def company_params
      params.require(:company).permit(:logo, :country_code, :phone_no, :street_address, :state, :postal_code, :overview, :since, product_ids: [], reports_attributes: [:id, :name, :document, :_destroy], references_attributes: [:id, :contact_person, :name, :website, :email, :phone, :_destroy])
    end
