namespace :email_providers_domains do

  desc "Read email_providers_domains.txt file, remove duplicate domains and sort"
  task remove_duplicates: :environment do
    puts "Reading file..."
    domains = File.read("./email_providers_domains.txt").split("\n")
    ...
    begin
      ...
      File.open("email_providers_domains.txt", "w+") { |file| file.puts domains }
    rescue Exception => e
  ...
  desc "Import all domains data from email_providers_domains.txt file"
